      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="max-w-3xl animate-fade-up">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-frost/40 bg-card/40 px-4 py-1.5 backdrop-blur">
            ...
            <span className="text-xs uppercase tracking-[0.3em] text-frost">Realm Online · 1,247 Players</span>
          </div>
          ...
          <h1 className="font-display text-6xl font-bold leading-[1.05] sm:text-7xl lg:text-8xl">
            ...
            <span className="mt-2 block text-3xl font-normal tracking-[0.4em] text-muted-foreground sm:text-4xl">
              FROZEN LEGACY
            </span>
          </h1>

          <p className="mt-8 max-w-xl text-lg leading-relaxed text-muted-foreground">
            Erlebe World of Warcraft <span className="text-frost">Wrath of the Lich King</span> wie damals — Patch 3.3.5a, blizzlike scripting, Icecrown Citadel auf Pre-Nerf Werten. Powered by AzerothCore.
          </p>

          <div className="mt-10 flex flex-wrap gap-4">
            <a
              href="#join"
              className="group relative inline-flex items-center gap-3 overflow-hidden rounded-md border border-frost/60 bg-frost/10 px-8 py-4 text-sm font-display uppercase tracking-[0.25em] text-frost backdrop-blur transition-all hover:bg-frost/20 animate-pulse-frost"
            >
              <span className="relative z-10">Jetzt Beitreten</span>
            ...
            <a
              href="#armory"
              className="inline-flex items-center gap-2 rounded-md border border-border bg-card/40 px-8 py-4 text-sm font-display uppercase tracking-[0.25em] text-foreground backdrop-blur transition hover:border-frost/60 hover:text-frost"
            >
              Armory Erkunden
            </a>
          </div>
          ...
          <div className="mt-14 grid max-w-2xl grid-cols-3 gap-px overflow-hidden rounded-lg border border-frost/20 bg-frost/20 backdrop-blur">
            {[
              { icon: Users, label: "Online", value: "1,247" },
              { icon: Server, label: "Uptime", value: "99.9%" },
              { icon: Zap, label: "Rates", value: "x1 – x10" },
            ].map((s) => (
              <div key={s.label} className="flex items-center gap-3 bg-card/80 px-6 py-5">
                <s.icon className="h-5 w-5 text-frost" />
                <div>
