...
export const Route = createRootRouteWithContext<MyRouterContext>()({
  head: () => ({
    meta: [
      ...
      { title: "Kaelthas · WoW WotLK 3.3.5a Realm" },
      { name: "description", content: "Kaelthas — blizzlike Wrath of the Lich King Server auf AzerothCore." },
      { name: "author", content: "Kaelthas Realm" },
